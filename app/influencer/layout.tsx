...
const NAV_ITEMS = [
  ...
  { href: '/influencer/gigs',      label: 'Browse Gigs',    icon: Search,          iconBg: 'rgba(6,182,212,0.5)',  iconColor: '#fff' },
  { href: '/influencer/pitches',   label: 'My Pitches',     icon: Send,            iconBg: 'rgba(168,85,247,0.5)', iconColor: '#fff' },
  { href: '/influencer/collabs',   label: 'Collaborations', icon: Briefcase,       iconBg: 'rgba(16,185,129,0.5)', iconColor: '#fff' },
  { href: '/influencer/earnings',  label: 'Earnings',       icon: Wallet,          iconBg: 'rgba(249,115,22,0.5)', iconColor: '#fff' },
  { href: '/influencer/profile',   label: 'Profile',        icon: User,            iconBg: 'rgba(236,72,153,0.5)', iconColor: '#fff' },
]
